...
<h4>Sign-Up or Register</h4>
<form action="SignupAction.jsp" method="post">

<div class="form-row">
<div class="col-lg-7">
<input type="Username" name="name" placeholder="Username" class="form-control  my-3 p-4">
</div>
 </div>
...
<input type="Email" name="email" placeholder="Email-Address" class="form-control my-3 p-4">
 ...
 <div class="form-row">
<div class="col-lg-7">
<input type="Mobile" name="mobilenumber" placeholder="Mobile Number" class="form-control  my-3 p-4">
</div>
 </div>
...
<option value="What was your car name"> What was our car name?</option>
<option value="What was your pet name">What was our pet name</option>
<option value="What was your teacher name">What was our teacher name</option>
<option value="What was your mother name">What was our mother name</option>
</select>


 <div class="form-row">
<div class="col-lg-7">
<input type="Answer" name="answer" placeholder="Answer" class="form-control  my-3 p-4">
</div>
 </div>
...
<input type="Password" name="password" placeholder="**********" class="form-control  my-3 p-4">
 ...
 <div class="form-row">
<div class="col-lg-7">
<input type="Address"  name="address" placeholder="Address" class="form-control  my-3 p-4">
</div>
 </div>
 
 <div class="form-row">
<div class="col-lg-7">
<input type="city" name="city" placeholder="City" class="form-control  my-3 p-4">
</div>
 </div>
 
 <div class="form-row">
<div class="col-lg-7">
<input type="state" name="state"  placeholder="State" class="form-control  my-3 p-4">
</div>
 </div>
 
 <div class="form-row">
<div class="col-lg-7">
<input type="Country" name="country" placeholder="Country" class="form-control  my-3 p-4">
</div>
 </div>
  ...
  <div class="form-row">
<div class="col-lg-7 ">
<button type="submit" class="btn1 mt-3 mb-3">Register</button>
</div>
 </div>
